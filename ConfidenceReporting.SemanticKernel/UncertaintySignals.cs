...
/// Duplicated from ConfidenceReporting.AgentFramework/UncertaintySignals.cs — samples in this
/// repo stay standalone, so no project reference is shared between the two flavors.
internal static class UncertaintySignals
{
